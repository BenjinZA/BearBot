...
class Giveaway(commands.Cog):
    ...
    async def startgiveaway(self, ctx, *, details):
        if self.live:
    ...
    @commands.command(brief='End a giveaway')
    @commands.has_any_role('Admin', 'Führer')
    ...
    @commands.command(brief='Select the giveaway winner')
    @commands.has_any_role('Admin', 'Führer')
    ...
    @commands.command(brief='Enter a giveaway')
    ...
    @commands.command(brief='Leave a giveaway')
    async def exitgiveaway(self, ctx):
        if not self.live:
            await ctx.send('No giveaway is currently live')
    ...
    @commands.command(brief='Clears any left over giveaway data')
    @commands.has_any_role('Admin', 'Führer')
    async def cleargiveaway(self, ctx):
        self.live = False
        pickle.dump(self.live, open('giveaway/live.txt', 'wb'))
    ...
    @commands.command(brief='Lists all users entered in the giveaway')
    async def giveawayusers(self, ctx):
    ...
    @commands.command(brief='Remove someone from giveaway')
    @commands.has_any_role('Admin', 'Führer')
    async def removefromgiveaway(self, ctx, num_user):
